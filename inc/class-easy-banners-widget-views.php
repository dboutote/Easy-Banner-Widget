...
/**
 * Easy_Banners_Widget_Views Class
 *
...
class Easy_Banners_Widget_Views
{
	...
	public static function banner( $instance, $echo = true )
	{
		...
		$item_id    = Easy_Banners_Widget_Utils::get_item_id( $instance );
		$item_class = Easy_Banners_Widget_Utils::get_item_class( $instance );
		$item_style = Easy_Banners_Widget_Utils::get_item_style( $instance );
	...
	{
		$attribution = '<!-- Easy Banners Widget generated by http://darrinb.com/plugins/easy-banners-widget -->';
