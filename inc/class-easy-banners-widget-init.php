...
/**
 * Easy_Banners_Widget_Init Class
 *
...
class Easy_Banners_Widget_Init
{
	 ...
	 *
	 * @see Easy_Banners_Widget_Init::register_widget()
	 *
	 * @access public
	 *
	 * @since 1.0.0
	...
	{
		register_widget( 'Widget_Easy_CTA_Banners' );
	}
	 ...
	 *
	 * @see Easy_Banners_Widget_Init::admin_scripts()
	 * @see Easy_Banners_Widget_Init::admin_styles()
	 *
	 * @access public
	 *
	 * @since 1.0.0
	 ...
	 *
	 * @see Easy_Banners_Widget_Init::maybe_store_css()
	 *
	 * @access public
	 *
	 * @since 1.0.0
	...
	public function store_css_option()
	{
		...
		add_action( 'customize_save_widget_easy-banners-widget', array( $this, 'maybe_store_css' ), 0, 1 );
	}
	 ...
	 *       widget: 'customize_save_widget_easy-banners-widget'
	 *
	 * @uses Easy_Banners_Widget_Utils::stick_css()
	 * @uses Easy_Banners_Widget_Utils::unstick_css()
	 *
	 * @access public
	 *
	 * @since 1.0.0
	...
	public function maybe_store_css( $widget, $instance = array(), $new_instance = array(), $old_instance = array() )
	{
		...
		if( 'customize_save_widget_easy-banners-widget' === $current_filter ){
		...
		if( ! empty ( $instance['css_default'] ) ) {
			Easy_Banners_Widget_Utils::stick_css( $widget_id );
		} else {
	 ...
	 *
	 * @see Easy_Banners_Widget_Init::enqueue_front_styles()
	 *
	 * @access public
	 *
	 * @since 1.0.0
	...
	public function front_styles()
	{
		...
		foreach( $widgets as $widget_id ) {
			if( is_active_widget( '', $widget_id, 'easy-banners-widget', true ) ) {
				$enqueue = true;
			}
		}
