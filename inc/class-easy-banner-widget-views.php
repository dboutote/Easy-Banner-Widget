...
/**
 * Easy_Banner_Widget_Views Class
 *
 ...
 * @subpackage Easy_Banner_Widget_Views
 *
 * @since 1.0
 */


class Easy_Banner_Widget_Views
{
	 ...
	 */
	public static function banner( $instance, $echo = true )
	{
		if( empty( $instance['banner_text'] ) ){
			return;
		}
		...
		$item_id    = Easy_Banner_Widget_Utils::get_item_id( $instance );
		$item_class = Easy_Banner_Widget_Utils::get_item_class( $instance );
		$item_style = Easy_Banner_Widget_Utils::get_item_style( $instance );
	...
	{
		$attribution = '<!-- Easy Banner Widget generated by http://darrinb.com/plugins/easy-banner-widget -->';
